  ...
  })(
    {
      1: [
        function (a, b) {
          ...
          function l() {}
          function m(a, b, c) {
            l.call(this), (this.cue = b), (this.cueDiv = h(a, b.text));
            var d = {
          ...
          function n(a) {
            ...
            if (a.div) {
              ...
              (a = a.div.getBoundingClientRect()),
                (b = f
                  ? Math.max((f[0] && f[0].height) || 0, a.height / f.length)
                  : 0);
            }
            (this.left = a.left),
              (this.right = a.right),
      ...
      2: [
        function (a, b) {
          ...
          var f = "auto",
            g = { "": 1, lr: 1, rl: 1 },
            h = { start: 1, middle: 1, end: 1, left: 1, right: 1 };
